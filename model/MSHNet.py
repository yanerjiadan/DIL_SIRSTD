...
if __name__ == '__main__':
    ...
    output = model.forward(input, deep_supervision=False)
    from thop import profile
    from torchsummary import summary
    flops, params = profile(model, inputs=(input, ))
    summary(model, input_size=(3, 256, 256), batch_size=8)
    print('-'*50)
    print(f'flops: {int(flops/1000000)}M, params: {int(params/1000000)}M')
